...
def generar_pdf_instrucciones_bytes():
    ...
    story = [
        ...
        Paragraph("• <b>/presión</b> o <b>/presion</b>: Registrar presión (Ej: <code>/presión 120,80,70</code> o <code>/presión 120,80</code>) o consultar resumen mensual de presión (Ej: <code>/presión 2026-08</code>).", body_style),
...
def main():
    ...
    application.add_handler(CommandHandler("presión", cmd_presion_handler))
